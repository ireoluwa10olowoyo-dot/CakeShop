...
import CakeLogo from "../assets/CakeLogo.webp";
...
return(
    ...
    <div className="fixed top-0 left-0 right-0 z-50 flex h-30 items-center bg-pink-100 gap-60 w-254.2">
        ...
        <img src={CakeLogo} className="w-35 h-30 mix-blend-multiply"/><p className="ml-1 text-3xl text-sky-900 ">Delicake</p>
        </div>
        ...
        <input type="text"className="bg-white rounded-xl mr-10 w-285 h-8 border-3 border-pink-500 ring-3 ring-offset-2 ring-pink-400 text-lg" /><img className="absolute right-1  w-7 h-7 mix-blend-multiply" src={SearchIcon}/>
